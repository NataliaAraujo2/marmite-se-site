    ...
    <div key={cartProduct.id}>
                          ...
                          {accompaniments && (
                            <div className={styles.accompanimentsBox}>
                              <div className={styles.navAccompaniments}>
                                ...
                                <button
                                  onClick={() => setAccompaniments(false)}
                                >
                                  Fechar
                                </button>
                              </div>
      ...
      {!button && (
        <div className={styles.productListCheckout}>
          <div className={styles.imageCheckout}>
            <img src={cartProduct.product.url} alt={cartProduct.product.name} />
          </div>
          <div className={styles.productDetailsCheckout} key={cartProduct.id}>
            <div className={styles.nameCheckout}>
              <span>{cartProduct.product.name}</span>
              {cartProduct.accompaniments.map((accompanimentChoiced, index) => (
                <li key={index}>{accompanimentChoiced.accompaniment}</li>
              ))}
            </div>

            <span className={styles.qtyCheckout}> {cartProduct.qty}</span>
            <span className={styles.priceCheckout}>R${cartProduct.totalPrice}</span>
          </div>
        </div>
      )}
    </div>
